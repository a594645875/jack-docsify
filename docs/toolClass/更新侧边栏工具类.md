...
public class DocsifyAuto {
    ...
    private static void recreateSidebar(File subfile) {
        ...
        try (PrintStream stream = new PrintStream(sidebarPath)) {
            stream.print(sidebar);
    ...
    private static String toSidebar(String directoryName, List<String> docNameList) {
        ...
        for (String docName : docNameList) {
            builder.append("\t").append("- [").append(docName).append("](/").append(directoryName).append("/").append(docName).append(")\n");
        }
